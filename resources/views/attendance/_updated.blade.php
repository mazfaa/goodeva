      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="text-center justify-content-center">
            ...
            <button type="button" class="btn btn-primary" id="camera-btn" data-bs-toggle="modal" data-bs-target="#camera-modal">
              <i class="bi bi-camera"></i> <span class="align-middle">Clock Out</span>
            </button>
          </div>
        </div>
      </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="{{ route('attendance.update', $id) }}" method="post" id="image-form-update"> 
            @csrf
            @method('put')
            <input type="hidden" name="image" id="image-input-update">
            <input type="hidden" name="coords" id="coordinate-input-update">
          </form>
        </div>
        <div class="modal-footer justify-content-between">
          ...
          <button type="submit" class="btn btn-sm btn-primary d-none" id="send-photo-btn-update" form="image-form-update"><i class="bi bi-upload me-1"></i> Send Photo</button>
        </div>
      </div>
    </div>
  </div>
